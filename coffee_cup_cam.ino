///////////////////////////////////////////////////////////////////////////////////
// Coffee Cup Capture Camera by Steve Hobley (www.stephenhobley.com) 
// [Based on the 
...
// Make the reset lower than the tilt to add a little software hysteresis
#define THRESHOLD_TILT 800
#define THRESHOLD_RESET 600
...
void setup() 
{
    ...
    // set jpeg quality
    VC0706_compression_ratio(90);
    delay(100);

    capture_photo("setup.jpg");
...
/*******************************************************************************/
void FlashPin(int nooftimes, int pin)
{
...
/*******************************************************************************/
boolean CheckForReset(int pin)
{
  return (ReadAxis(pin) > THRESHOLD_RESET);
}
/*******************************************************************************
